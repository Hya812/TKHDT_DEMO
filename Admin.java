...
//	    // B1: Kiem tra thong tin tuyen co ton tai khong
	...
	static void testRequestHeatmapReport() {
	    ...
	    assertTest("list co it nhat 1 canh bao sau khi vuot nguong",
	            report.size() >= 1);

	    boolean dungStation = report.stream()
	            .anyMatch(a -> a.getStation()
	                    .getStationName()
	                    .equals("Ga Test Heatmap"));
